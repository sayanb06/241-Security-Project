// inspiration from: https://github.com/jarun/keysniffer
...
// notifier block seems like part of an interrupt handler
 ...
 * @type: log pattern
 */
// i think it's printing character by character
...
static int __init keysniffer_init(void)
{
	 ...
	 * //sayan: basically an interrupt handler
	 */
